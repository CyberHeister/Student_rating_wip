...
public class TestingJDBC 
{
    ...
    {	
        ...
        HashMap<Integer, Students> m = new HashMap<Integer, Students>();
        Students std;
        StudentScore stdsc;
        Statement st=null;
        ResultSet rs=null;
        ...
        for(Integer i : m.keySet()){
            Students std1 = m.get(i);
            System.out.println(" "+std1.getStudent_name()+" "+std1.getAssignment_category());
        }
        
        // show data from hashmap using our ToString Method
        /*System.out.println("______With ToString______");
        for(Integer i : m.keySet()){
            StudentScore std1 = m.get(i);
